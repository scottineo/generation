...
public class Atividade3 {
	...
	public static void main(String[] args) {
		float salario_bruto, adc_noturno, hora_extra, descontos, salario_liquido;
		Scanner leia = new Scanner(System.in);
		System.out.println("Vamos calcular o seu salário! Digite as informações pedidas abaixo usando duas casas decimais após a vírgula.");
